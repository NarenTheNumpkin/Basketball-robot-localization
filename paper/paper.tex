...
The two tailed critical t-value for $\alpha=0.05$ and df=7 is $\pm2.365$. Since our calculated t-statistic of -0.89 is less than -2.365, we fail to reject the null hypothesis. The corresponding p-value is 0.40. This confirms there is no statistically significant relationship.
